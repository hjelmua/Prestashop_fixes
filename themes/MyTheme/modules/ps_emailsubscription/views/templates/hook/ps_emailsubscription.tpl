...
<div class="block_newsletter links col-xs-12 col-lg-3">
  <p class="h3">{l s='Newsletter' d='Shop.Theme.Global'}</p>
  {assign var=_expand_id value=10|mt_rand:100000}
  <div class="title hidden-lg-up" data-target="#footer_sub_menu_{$_expand_id}" data-toggle="collapse">
    <span class="navbar-toggler collapse-icons">
      <i class="material-icons add">&#xE313;</i>
      <i class="material-icons remove">&#xE316;</i>
    </span>
  </div>
  <div id="footer_sub_menu_{$_expand_id}" class="footer-toggle collapse">
