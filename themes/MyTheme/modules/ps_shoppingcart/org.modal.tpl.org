        ...
        <div class="row">
          <div class="col-md-6 divide-right">
            <div class="row">
              <div class="col-md-5">
                {if $product.cover}
                <img class="product-image" src="{$product.cover.medium.url}" srcset="{$product.cover.medium.url} 1x, {$product.cover.bySize.home_default2x.url} 2x" alt="{$product.cover.legend}" title="{$product.cover.legend}" itemprop="image">
                {else}
                <img class="product-image" src="/img/p/sv-default-home_default.jpg" itemprop="image">
                {/if}                
              </div>
              <div class="col-md-7">
